...
anneals = [
    'data/oven/MTS Pre-Irradiation.xlsx',
    'data/oven/MCP Pre-Irradiation.xlsx',
    'data/oven/MCP MTS Post-Irradiation.xlsx'
]
...
plt.savefig(f'results/figures/heat_profiles.pdf')